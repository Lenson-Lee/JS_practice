...
function calcBMI (h, w) {
    var bmi = w / (h/100) ** 2;//0.1 = 나누기 100 (cm -> m)
    ...
    // return Math.round(bmi * 100) / 100;//변수명을 안적어서 mybmi출력이 안되던거다..
    return round(bmi,2); //round함수 정의해서 소숫점 입력하면 자동으로 자릿수 되도록   
}
...
//     Math.round(targetNum * 10 ** position) / 10 ** position;
// }
